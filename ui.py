...
row0col0Frame = (tableFrame) # empty frame to fit gird
row0col1Frame = (tableFrame) # 123 column
row0col2Frame = (tableFrame) # 456 column
row0col3Frame = (tableFrame) # 789 column
row1col0Frame = (tableFrame) # 123 row
row2col0Frame = (tableFrame) # 456 row
row3col0Frame = (tableFrame) # 789 row
# table 3x3
row1col1Frame = (tableFrame)
row1col2Frame = (tableFrame)
row1col3Frame = (tableFrame)
row2col1Frame = (tableFrame)
row2col2Frame = (tableFrame)
row2col3Frame = (tableFrame)
row3col1Frame = (tableFrame)
row3col2Frame = (tableFrame)
row3col3Frame = (tableFrame)

# Label display row column at
Label(row0col0Frame, text=" ").grid(row=0,column=0) # empty grid
# show columns
Label(row0col1Frame, text="1", font=24).grid(row=0,column=0)
Label(row0col1Frame, text="2", font=24).grid(row=0,column=1)
Label(row0col1Frame, text="3", font=24).grid(row=0,columm=2)
Label(row0col2Frame, text="4", font=24).grid(row=0,column=0)
Label(row0col2Frame, text="5", font=24).grid(row=0,column=1)
Label(row0col2Frame, text="6", font=24).grid(row=0,column=2)
Label(row0col3Frame, text="7", font=24).grid(row=0,column=0)
Label(row0col3Frame, text="8", font=24).grid(row=0,column=1)
Label(row0col3Frame, text="9", font=24).grid(row=0,column=2)
# show rows
Label(row1col0Frame, text="1", font=24).grid(row=0,column=0)
Label(row1col0Frame, text="2", font=24).grid(row=1,column=0)
Label(row1col0Frame, text="3", font=24).grid(row=2,columm=0)
Label(row2col0Frame, text="4", font=24).grid(row=0,column=0)
Label(row2col0Frame, text="5", font=24).grid(row=1,column=0)
Label(row2col0Frame, text="6", font=24).grid(row=2,column=0)
Label(row3col0Frame, text="7", font=24).grid(row=0,column=0)
Label(row3col0Frame, text="8", font=24).grid(row=1,column=0)
Label(row3col0Frame, text="9", font=24).grid(row=2,column=0)
...
row0col0Frame.grid(row=0,column=0)
row0col1Frame.grid(row=0,column=1)
row0col2Frame.grid(row=0,column=2)
row0col3Frame.grid(row=0,column=3)
row1col0Frame.grid(row=1,column=0)
row2col0Frame.grid(row=2,column=0)
row3col0Frame.grid(row=3,column=0)
row1col1Frame.grid(row=1,column=1)
row1col2Frame.grid(row=1,column=2)
row1col3Frame.grid(row=1,column=3)
row2col1Frame.grid(row=2,column=1)
row2col2Frame.grid(row=2,column=2)
row2col3Frame.grid(row=2,column=3)
row3col1Frame.grid(row=3,column=1)
row3col2Frame.grid(row=3,column=2)
row3col3Frame.grid(row=3,column=3)
# # Row 1
# r1c1 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr1c1)
# r1c2 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr1c2)
# r1c3 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr1c3)
# r1c4 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr1c4)
# r1c5 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr1c5)
# r1c6 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr1c6)
# r1c7 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr1c7)
# r1c8 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr1c8)
# r1c9 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr1c9)
# # Row 2
# r2c1 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr2c1)
# r2c2 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr2c2)
# r2c3 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr2c3)
# r2c4 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr2c4)
# r2c5 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr2c5)
# r2c6 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr2c6)
# r2c7 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr2c7)  
# r2c8 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr2c8)
# r2c9 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr2c9)
# # Row 3
# r3c1 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr3c1)
# r3c2 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr3c2)
# r3c3 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr3c3)
# r3c4 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr3c4)
# r3c5 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr3c5)
# r3c6 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr3c6)
# r3c7 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr3c7)
# r3c8 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr3c8)
# r3c9 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr3c9)
# # Row 4
# r4c2 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr4c2)
# r4c3 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr4c3)
# r4c1 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr4c1)
# r4c4 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr4c4)
# r4c5 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr4c5)
# r4c6 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr4c6)
# r4c7 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr4c7)
# r4c8 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr4c8)
# r4c9 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr4c9)
# # Row 5
# r5c1 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr5c1)
# r5c2 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr5c2)
# r5c3 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr5c3)
# r5c4 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr5c4)
# r5c5 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr5c5)
# r5c6 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr5c6)
# r5c7 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr5c7)
# r5c8 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr5c8)
# r5c9 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr5c9)
# # Row 6
# r6c1 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr6c1)
# r6c2 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr6c2)
# r6c3 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr6c3)
# r6c4 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr6c4)
# r6c5 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr6c5)
# r6c6 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr6c6)
# r6c7 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr6c7)
# r6c8 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr6c8)
# r6c9 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr6c9)
# # Row 7
# r7c1 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr7c1)
# r7c2 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr7c2)
# r7c3 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr7c3)
# r7c4 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr7c4)
# r7c5 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr7c5)
# r7c6 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr7c6)
# r7c7 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr7c7)
# r7c8 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr7c8)
# r7c9 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr7c9)
# # Row 8
# r8c1 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr8c1)
# r8c2 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr8c2)
# r8c3 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr8c3)
# r8c4 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr8c4)
# r8c5 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr8c5)
# r8c6 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr8c6)
# r8c7 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr8c7)
# r8c8 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr8c8)
# r8c9 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr8c9)
# # Row 9
# r9c1 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr9c1)
# r9c2 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr9c2)
# r9c3 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr9c3)
# r9c4 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr9c4)
# r9c5 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr9c5)
# r9c6 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr9c6)
# r9c7 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr9c7)
# r9c8 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr9c8)
# r9c9 =  Entry(tableFrame, font=24, width=2, justify=CENTER, textvariable=vr9c9)
